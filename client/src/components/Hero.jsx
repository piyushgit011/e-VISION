    ...
    <div className="box flex flex-col md:flex-row gap-3 md:gap-5 relative justify-between items-center text-white my-14 sm:my-16 md:my-24 ">
      ...
      >
        ...
        <p className="text-[10px] sm:text-sm md:text-base lg:text-lg text-gray-400">
          ...
          obcaecati provident inventore consequatur, laborum error assumenda
          natus fugit sed autem mollitia neque nam odit! Debitis facilis in,
          consectetur magni accusantium modi,
        </p>
      </motion.div>
      <motion.div
